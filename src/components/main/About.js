  ...
  return (
    <div className="about">
      ...
      <div className="about-body">
        ...
        meticulously designed and printed using high-quality materials to ensure
        that you receive a product that meets our utmost standards. Marvel
        Poster Universe is here to transform your living space into a thrilling
        realm where heroes come alive and imagination knows no bounds. Join us
        on this incredible journey and let the Marvel magic ignite your walls.
      </div>
    </div>
  );
};
